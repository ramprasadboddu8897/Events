...
class Events extends Component {
  state = {eventStatus: eventStatusConstants.initial}
  ...
  renderEventsContainer = () => (
    <div className="events-container">
      <h1>Events</h1>
      <ul className="events-itemList">
        {eventsList.map(eachItem => (
          <EventItem
            displayStatusEvent={this.displayStatusEvent}
            key={eachItem.id}
  ...
  renderEventRegistrationDetails = () => {
    ...
    return <ActiveEventRegistrationDetails eventStatus={eventStatus} />
  }
  ...
  render() {
    return (
      <div className="app-container">
        ...
        {this.renderEventRegistrationDetails()}
      </div>
    )
  }
}
